CREATE DATABASE  IF NOT EXISTS `productos` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `productos`;
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'baafdc8b-0e04-11ee-8fbf-42010a400003:1-764';
...
INSERT INTO `categoria` VALUES (1,'Instrumentos de Cuerdas'),(2,'Percusión'),(3,'Amplificadores'),(4,'Accesorios');
...
INSERT INTO `subcategoria` VALUES (1,'Guitarras'),(2,'Bajos'),(3,'Pianos'),(4,'Baterías Acústicas'),(5,'Baterías Electrónicas'),(6,'Cabezales'),(7,'Cajas'),(8,'Varios');
...
-- Dump completed on 2023-06-18 15:19:59
